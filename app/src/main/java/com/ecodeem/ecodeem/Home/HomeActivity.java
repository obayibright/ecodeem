...
import com.ecodeem.ecodeem.Login.WelcomeActivity;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void setupViewPager(){
        ...
        tabLayout.getTabAt(1).setText(R.string.fragment_home);
        tabLayout.getTabAt(2).setText(R.string.fragment_messages);
    }
